...
import { ReportTab, ApplicationTab, PolicyTab, ClaimTab, InvoiceTab, CancellationsTab, DetailsTab } from "./Tabs"

const TABS = [
  { title: "Report", icon: "General.Report" },
  { title: "Applications", icon: "HomePlaces.MapsHomeWork" },
  { title: "Policy", icon: "FileFolder.FindInPage" },
  { title: "Claim", icon: "HomePlaces.Gite" },
  { title: "Invoice", icon: "FileFolder.Receipt" },
  { title: "Details", icon: "FileFolder.Plagiarism" },
  { title: "Flagged Cancellation", icon: "General.Flag" },
]

export const EmailBuildingDetail = () => {
