      ...
      <Box display="flex" flexDirection="column" sx={{ padding: '0px 24px', gap: '4px' }}>
        <Box display="flex" flexDirection="column" padding="16px 0px" gap="12px">
          ...
          <Box display="flex" gap="8px">
            ...
            <RateCard
              title="Total # Leap Active Units"
              value={building.total_of_active_leap_units}
            />
            <RateCard title="Leap % Total Inventory" value={building.leap_of_total_inventory} />
            <RateCard
              title="Estimated App. Decline Rate"
              value={building.estimated_applicant_decline_rate}
            />
          </Box>
        </Box>
        ...
        <Box display="flex" flexDirection="column" padding="16px 0px" gap="12px">
          ...
          <Box display="flex" gap="8px" flexDirection="column">
            <Box display="flex" gap="8px">
              ...
              <SummaryCard
                title="Total # of Decisioned App"
                value={building.total_of_decisioned_app}
              />
            ...
            <Box display="flex" gap="8px">
              <SummaryCard
                title="Total # of Cancelled Apps."
                value={building.total_of_cancelled_applications}
              />
              <SummaryCard
                title="Building Approved to Issue"
                value={building.building_approved_to_issue_rate}
              />
              <SummaryCard
                title="Total # of Approved Apps"
                value={building.total_of_approved_app}
              />
              <SummaryCard
                title="Total # of Issued Policies"
                value={building.total_of_issued_policies}
              />
            </Box>

            <Box display="flex" gap="8px">
              <SummaryCard
                title="Total # of Declined App"
                value={building.total_of_declined_applications}
              />
