                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRenderer: (value, tableMeta) => (
                            value ? <IconGraphy icon={'Arrow.North'} style={{ color: '#702572' }} onClick={() => goDetailPage(tableMeta)} />
                                : <IconGraphy icon={'Arrow.NorthEast'} style={{ color: '#702572' }} onClick={() => goDetailPage(tableMeta)} />
                        ),
                    },
                    key: 'link',
                },
